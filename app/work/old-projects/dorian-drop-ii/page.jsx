              ...
              <div className="w-layout-grid work-grid wrap">
                <div id="w-node-_44426597-a8a8-c0a7-ee22-d15b82e5f8da-1f2416dc" className="work-main-wrap first">
                  <div className="w-layout-grid cs-grid _3-col" data-reveal-group>
                    <div id="w-node-_44426597-a8a8-c0a7-ee22-d15b82e5f8dc-1f2416dc" style={{ paddingTop: '56.17021276595745%' }} className="w-embed-youtubevideo" data-reveal><iframe src="https://www.youtube.com/embed/0CCLweTo1Fo?rel=0&amp;controls=1&amp;autoplay=0&amp;mute=0&amp;start=0" frameBorder="0" style={{ position: 'absolute', left: '0', top: '0', width: '100%', height: '100%', pointerEvents: 'auto' }} allow="autoplay; encrypted-media" allowFullScreen title="Dorian - DROP II (Official lyrics video)"></iframe></div>
