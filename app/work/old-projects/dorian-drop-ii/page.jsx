              ...
              <div className="w-layout-grid work-grid wrap">
                <div id="w-node-_44426597-a8a8-c0a7-ee22-d15b82e5f8da-1f2416dc" className="work-main-wrap first">
                  <div className="w-layout-grid cs-grid _3-col">
                    ...
                    <div id="w-node-_82b332d6-fc71-bc4e-ba25-6ba5e8d8c85d-1f2416dc" className="wrapper"><img src={CDN + '/images/lucrative.webp'} loading="lazy" id="w-node-_44426597-a8a8-c0a7-ee22-d15b82e5f8dd-1f2416dc" sizes="(max-width: 767px) 100vw, (max-width: 991px) 95vw, 940px" alt="Dorian drop image" srcSet={`${CDN}/images/lucrative-p-500.webp 500w, ${CDN}/images/lucrative-p-800.webp 800w, ${CDN}/images/lucrative-p-1080.webp 1080w, ${CDN}/images/lucrative-p-1600.webp 1600w, ${CDN}/images/lucrative.webp 1620w`} className="image-14" /></div>
